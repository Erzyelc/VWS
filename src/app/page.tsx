...
function CaseStudies({
  ...
  return (
    <>
      ...
      >
        <p>
          We work with a diverse range of clients to create beautiful, engaging
          digital experiences. Here are some of our recent projects.
        </p>
      </SectionIntro>
      ...
      <Container className="mt-16">
        <div className="lg:flex lg:items-center lg:justify-end">
          ...
          <List className="mt-16 lg:mt-0 lg:w-1/2 lg:min-w-[33rem] lg:pl-4">
            ...
            <ListItem title="Framer and Webflow Development">
              We are experts in Framer and Webflow. We can create stunning
              animations and interactions that will make your website stand out.
            </ListItem>
          </List>
        </div>
      </Container>
      ...
      <Container className="mt-24 sm:mt-32 md:mt-56">
        <FadeIn className="max-w-3xl">
          <h1 className="font-display text-5xl font-medium tracking-tight text-neutral-900 [text-wrap:balance] sm:text-7xl">
            Web Development & Design studio based in the United States.
          </h1>
          <p className="mt-6 text-xl text-neutral-500">
            We are a development studio working to bring your ideas to life,
            from concept to launch. We work at the intersection of design and
            technology to create engaging digital experiences.
          </p>
        </FadeIn>
      </Container>
